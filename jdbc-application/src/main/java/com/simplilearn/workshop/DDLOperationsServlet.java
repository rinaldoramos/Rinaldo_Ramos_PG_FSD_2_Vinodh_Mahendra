...
/**
 * Servlet implementation class DDLOperationsServlet
 */
...
public class DDLOperationsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			/*
			 * //Creating a table String CREATE_SQL =
			 * "create table department (eid int(5), deptno char(10), deptname varchar(10))"
			 * ;
			 * 
			...
			/*
			 * //Adding a new colum to an existing table String ALTER_SQL =
			 * "ALTER TABLE department ADD depthead varchar(15)";
			 * 
			 * Statement statement = connection.createStatement();
			 * 
